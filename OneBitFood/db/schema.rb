...
ActiveRecord::Schema.define(version: 2021_05_12_020654) do
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.integer "restaurtant_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.string "street"
    t.index ["restaurtant_id"], name: "index_orders_on_restaurtant_id"
  end
  ...
  add_foreign_key "orders", "restaurtants"
