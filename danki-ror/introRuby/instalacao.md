...
Nesta aula você irá configurar o seu ambiente de desenvolvimento e depois utilizar um gerenciador de versão para instalar o Ruby na versão 3.0


**Preparando seu ambiente – Ubuntu**
...
3. Utilize o Rbenv para instalar o Ruby na versão 3
